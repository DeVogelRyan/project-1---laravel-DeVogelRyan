...
<body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="ml-16 transform rotate-180 -rotate-180 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <form action="{{ url('contact/storeReply') }}" method="POST">
        ...
        <div class="w-6/12 ml-20 mt-2 shadow-2xl sm:rounded-md sm:overflow-hidden">
