...
<body>
        ...
        <div class="mt-2 shadow sm:rounded-md sm:overflow-hidden">
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        <input type="text" name="email" id="company-website"
                            class="focus:ring-indigo-700 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center">
                        <img class="h-12 w-12 rounded-full overflow-hidden" src="{{$user->profile_img}}" alt="ProfileImg">
                        <button type="button"
    ...
    <div x-data="{show: true}" x-init="setTimeout(()=>show = false, 4500)" x-show="show">
        <div class="w-72 fixed bottom-5 right-5 px-4 py-3 leading-normal text-green-700 bg-green-100 rounded-lg"
            role="alert">
