...
<body>
    ...
    <form action="{{ url('latestNews/update') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="col-span-3 sm:col-span-2">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <input type="text" name="title" id="company-website" value="{{$latestNews->title}}"
        ...
        <input name="currentId" value="{{$latestNews->id}}" hidden>
    </form>
