...
<body>
    ...
    {{-- <form class="max-w-full p-2 flex flex-col items-center justify-center mt-16" action="{{ url('posts') }}"
    ...
    <div class="md:flex md:items-center mb-6">
        ...
        <div class="md:w-2/3">
            <input
                ...
                id="inline-full-name" type="text" name="title" placeholder="...">
        </div>
    </div>
    <div class="md:flex md:items-center mb-6">
        <div class="md:w-1/3">
        ...
        <div class="md:w-2/3">
            <textarea
                class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                name="content" cols="3" rows="5"></textarea>
        </div>
    </div>
