            ...
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                  <input type="text" name="title" id="company-website" class="focus:ring-indigo-700 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300" placeholder="example title" required>
                </div>
              </div>
            </div>
                ...
                <div class="space-y-1 text-center">
                  ...
                  <div class="flex justify-center text-sm text-gray-600">
                    <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                      ...
                      <input id="file-upload" name="file" type="file" class="sr-only form-control{{ $errors->has('file') ? ' is-invalid' : '' }}" accept="image/*" required>
                    </label>
                  </div>
